...
var addButtonLabel = 'Submit Request';
...
function FormModal(modalEl, dataObj, opts){
    ...
    dataObj.forEach(function(column) {
      ...
      $body.append(`
        <div class="mb-3 row">
          ...
          <div class="col-sm-8">
            <textarea class="form-control" id="${key}" name="${key}" step="any" type="${type}" rows="7" placeholder="Please include as much information as possible. The data team will get back to you within 24 hours."></textarea>
          </div>
        </div>
      `);}
    })
  ...
  function submit(){
    ...
    person['pageId'] = domo.env.pageId;
    person['requestor'] = domo.env.userName;
